...
export const DATA_CATALOG: DatasetEntry[] = [
  ...
  },
  {
    ...
    coverage: {
      id: "Asia Tenggara (90–145°BT, 13°LS–22°LU), langkah 3 jam hingga 48 jam ke depan; 502 titik kabupaten/kota untuk angka per-wilayah",
      en: "Southeast Asia (90–145°E, 13°S–22°N), 3-hourly out to 48 h; 502 district points for the per-region numbers",
    },
    description: {
