...
export const DATA_CATALOG: DatasetEntry[] = [
  ...
  },
  {
    ...
    coverage: {
      id: "Asia & Australasia (60–180°BT, 50°LS–60°LU), grid asli CAMS 0,4°, langkah 3 jam hingga 48 jam ke depan; 502 titik kabupaten/kota untuk angka per-wilayah",
      en: "Asia & Australasia (60–180°E, 50°S–60°N) on CAMS's native 0.4° grid, 3-hourly out to 48 h; 502 district points for the per-region numbers",
    },
    description: {
